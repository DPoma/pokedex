...
public class HabilidadController {
	...
	public Pokemon agregarHabilidadPost(@PathVariable int pokemonId, @RequestParam int habilidadId) {
		Pokemon pokemon = pokemonService.buscarPorId(pokemonId);
		Habilidad habilidad = habilidadService.buscarPorId(habilidadId);
	...
	@DeleteMapping("/pokemones/{pokemonId}/habilidades/eliminar")
	public Pokemon eliminarHabilidadPost(@PathVariable int pokemonId, @RequestParam int habilidadId) {
		Pokemon pokemon = pokemonService.buscarPorId(pokemonId);
		Habilidad habilidad = habilidadService.buscarPorId(habilidadId);
